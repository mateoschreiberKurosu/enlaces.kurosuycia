...
function header(active) {
  ...
  <div class="container ks-shell-container"><div class="navbar-header">
    ...
    <li class="ks-site-menu__search"><button id="searchToggle" class="ks-search-toggle" type="button" aria-label="Buscar en el portal" aria-expanded="false" aria-controls="headerSearch">${icon("search")}</button><div id="headerSearch" class="ks-header-search" hidden><label class="sr-only" for="headerSearchInput">Buscar en el portal</label><input id="headerSearchInput" class="ks-search-input" data-ks-search-input data-ks-search-results-id="headerSearchResults" type="search" placeholder="Buscar productos, soporte o contacto" autocomplete="off"><div id="headerSearchResults" class="ks-header-search__results" data-ks-search-results aria-live="polite"></div></div></li>
...
export function layout({ title, description, active = "", body }) {
  return `<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="${description}"><meta name="theme-color" content="#102f22"><title>${title} | Kurosu &amp; Cía.</title><link rel="icon" href="/assets/images/kurosu-k-mark.png"><style>__INLINE_STYLES__</style></head><body>__ICON_SPRITE__${header(active)}<main id="mainContent" tabindex="-1">${body}</main>${footer()}<script>window.KS_SEARCH_INDEX=__SEARCH_INDEX__;window.KS_ROUTE_PREFIX="__ROUTE_PREFIX__";</script><script>__INLINE_APP_JS__</script></body></html>`;
}
