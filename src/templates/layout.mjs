...
function header(active) {
  ...
  <div class="container ks-shell-container"><div class="navbar-header">
    ...
    <li><a class="ks-search-link" href="/busqueda/" aria-label="Buscar">${icon("search")}</a></li>
...
function footer() {
  ...
  </div></div></div><div class="footer-bottom ks-site-footer__bottom"><div class="container ks-shell-container"><div class="ks-site-footer__legal"><p>Copyright © ${new Date().getFullYear()}. Todos los derechos reservados.</p></div></div></div></footer>`;
}

export function layout({ title, description, active = "", body }) {
  return `<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="${description}"><meta name="theme-color" content="#102f22"><title>${title} | Kurosu &amp; Cía.</title><link rel="icon" href="/assets/images/Logo-sm-64.png"><style>__INLINE_STYLES__</style></head><body>__ICON_SPRITE__${header(active)}<main id="mainContent" tabindex="-1">${body}</main>${footer()}<script>window.KS_SEARCH_INDEX=__SEARCH_INDEX__;</script><script>__INLINE_APP_JS__</script></body></html>`;
}
